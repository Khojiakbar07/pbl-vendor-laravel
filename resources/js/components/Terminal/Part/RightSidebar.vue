    ...
    <div class="w-5/12 flex flex-col bg-blue-gray-50 h-full bg-white pr-4 pl-2 py-4">
        <div class="bg-white rounded-3xl flex flex-col h-full shadow">
                ...
                <div class="flex-1 w-full px-4 overflow-auto">
                  ...
                  <div class="py-2">
                    <div class="w-28 grid grid-cols-3 gap-1 ml-2">
                      ...
                      <input @input="this.CalculateProducts" v-model="item.numberofProduct" type="text" class="bg-white rounded-lg text-center shadow focus:outline-none focus:shadow-lg text-sm" style="padding:0;">
            ...
            <div class="select-none h-auto w-full text-center pt-3 pb-4 px-4">
                ...
                <button @click="Payment" :class="{butonGreen: choseProducts.length !=0}" class="text-white rounded-2xl text-lg w-full py-3 focus:outline-none bg-blue-gray-200" :disabled="choseProducts.length==0">
                    To`lov
                </button>
            </div>
             <!-- end of payment info -->
