...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card mb-4">
                <h5 class="card-header">{{__('Edit')}}Edit Customer</h5>
                <form method="POST" action="{{ route('customer.update', $brand->id) }}" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <label for="exampleFormControlInput1" class="form-label">Customer Fullname</label>
